...
spec:
  ...
  source:
    ...
    repoURL: 'https://github.com/mchitara/cp4waiops-demo-gitops'
    targetRevision: HEAD
    helm:
      valueFiles:
        - values.yaml
...
- Clone my repository
- Replace all occurences in of `https://github.com/mchitara/cp4waiops-demo-gitops` with your cloned repository 
...
```
git clone https://github.com/mchitara/cp4waiops-demo-gitops.git --branch 3.2-stable 
```
